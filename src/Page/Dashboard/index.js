      ...
      <main>
        <section className={styles.cards}>
          <div className={styles.card}>
            <h2>Products Sold</h2>
            <p>57 <span className={styles.percentage}>12% <i className="material-icons">arrow_upward</i></span></p>
          </div>
          <div className={styles.card}>
            <h2>Gross Profit</h2>
            <p>$457 <span className={styles.percentage}>12% <i className="material-icons">arrow_downward</i></span></p>
          </div>
          <div className={styles.card}>
            <h2>New Customers</h2>
            <p>125 <span className={styles.percentage}>9% <i className="material-icons">arrow_downward</i></span></p>
          </div>
        </section>
